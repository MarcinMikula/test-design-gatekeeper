...
| Field | Value |
| --- | --- |
| Document version and date | 0.1 — 2026-09-16 |
...
| Requirement state | 15 MUST / PROPOSED; none accepted by document generation |
| Open policy decisions | 3 recommendations awaiting disposition |
...
### 4.1 Evidence contract — proposed OD-RA04-001
...
### 5.2 Separability — proposed OD-RA04-002
...
### 5.3 Package reporting — proposed OD-RA04-003
...
`Shall` expresses proposed mandatory behavior. A requirement becomes a binding baseline obligation only after Project Owner acceptance and the applicable review and baseline controls. `MUST` expresses priority, not acceptance or an implementation choice.

| ID | Requirement | Priority | Status | Upstream trace |
| --- | --- | --- | --- | --- |
| RA04-REQ-001 | TDG shall distinguish package prerequisites, item eligibility, domain qualification, capability availability and assessment-specific sufficiency before relying on an affected substantive result. | MUST | PROPOSED | RA02-REQ-007; RA03-REQ-031; RA03-REQ-032 |
| RA04-REQ-002 | TDG shall retain test level, functional objective, design basis, technique evidence, execution mode and relevant context as separate dimensions without deriving one solely from another. | MUST | PROPOSED | RA02-REQ-011; RA03-REQ-023 |
| RA04-REQ-003 | TDG shall ground qualification in addressable supplied content and applicable context; labels, titles, tool names, confidence scores and absence of implementation details shall not independently establish eligibility or exclusion. | MUST | PROPOSED | RA02-REQ-012; RA03-REQ-020; RA03-REQ-039 |
| RA04-REQ-004 | A supported domain conclusion shall satisfy RA04-C-01 through RA04-C-05 for the identified subject; integration, acceptance, structural-coverage and AI/LLM-evaluation objectives shall not be admitted through relabeling. | MUST | PROPOSED | Charter Sections 8–9; RA02-REQ-015; RA02-REQ-035; RA02-REQ-036 |
| RA04-REQ-005 | TDG shall apply RA04-Q-01 through RA04-Q-04, distinguishing evidence-supported exclusion from undetermined qualification and preserving additional established reasons and unresolved dimensions. | MUST | PROPOSED | RA02-REQ-013; RA03-REQ-035; RA03-REQ-040 |
| RA04-REQ-006 | TDG shall assess the role of technical setup, observations and implementation dependencies before classifying the design basis, preserving a supplied gray-box label without using it as a definitive verdict. | MUST | PROPOSED | Charter Section 9; RA02-REQ-012; RA02-REQ-013 |
| RA04-REQ-007 | An assessment view within a mixed TC shall meet all four separability conditions in Section 5.2, retain source references and necessary dependencies, and shall not rewrite the TC or imply whole-case qualification. | MUST | PROPOSED | RA02-REQ-014; RA03-REQ-006; RA03-REQ-041 |
| RA04-REQ-008 | TDG shall expose the supported subset and all exclusions or unresolved items without double-counting original TCs, hiding partial dimensions, or treating qualification counts as coverage or completeness. | MUST | PROPOSED | RA02-REQ-014; RA02-REQ-022; RA03-REQ-041 |
| RA04-REQ-009 | Substantive review of a TC shall require its applicable recognizable-content and accountable-origin conditions; another eligible TC in the package shall not satisfy those conditions on its behalf. | MUST | PROPOSED | Charter Section 8.1; RA03-REQ-011; RA03-REQ-021 |
| RA04-REQ-010 | TDG shall preserve supplied declarations, derived qualification, uncertainty and human decisions separately; unsupported decisive inference shall yield undetermined qualification, and probabilistic output shall not become a deterministic fact or human confirmation. | MUST | PROPOSED | RA02-REQ-020; RA02-REQ-023; RA03-REQ-027; RA03-REQ-039 |
| RA04-REQ-011 | TDG shall keep domain qualification separate from quality gaps, technique labels and technique-specific evidence; attributable experience-based cases may receive the accepted general review without forced reclassification or expansion of the four assessed techniques. | MUST | PROPOSED | Charter Section 8; RA03-REQ-016; RA03-REQ-022; RA03-REQ-024; RA03-REQ-034 |
| RA04-REQ-012 | Scope changes, source-precedence decisions and source correction shall retain their assigned human authority; clarification, changed supplied content and reassessment shall preserve the accepted package-versus-run version consequences. | MUST | PROPOSED | RA01-REQ-004; RA01-REQ-005; RA01-REQ-006; RA03-REQ-035; RA03-REQ-044; RA03-REQ-046 |
| RA04-REQ-013 | Each qualification result shall identify its package version, run, original item and any assessed view, criteria, supporting and conflicting source locations, derivation, behavior versions, limitations and actionable clarification need where applicable. | MUST | PROPOSED | RA02-REQ-018; RA02-REQ-022; RA03-REQ-038 |
| RA04-REQ-014 | Execution mode and supported representation shall be handled independently from domain eligibility; unavailable parsing or interpretation shall remain a capability limitation, without executing submitted testware or selecting an unauthorized fallback. | MUST | PROPOSED | RA02-REQ-021; RA03-REQ-012; RA03-REQ-019; RA03-REQ-025 |
| RA04-REQ-015 | Qualification shall express the scope and limits of TDG's review, without declaring an excluded TC defective merely because of exclusion or claiming testware approval, completeness, product quality or official ISTQB conformity. | MUST | PROPOSED | RA01-REQ-014; RA02-REQ-024; RA03-REQ-050 |
...
| RA04-EX-11 | Choose inputs to traverse specified code branches and assert branch coverage. | Outside structural-coverage scope, even if labeled system-functional |
...
| RA04-EX-20 | The actual objective is judging hallucinations in generated LLM answers. | Outside the parked AI/LLM target domain |
...
These are future validation conditions, not executed tests or implemented acceptance checks. Every obligation directly references proposed RA-04 requirements; every requirement has at least one obligation.
...
## 9. Open policy decisions and recommendations

Inherited scope, roles, partial-review permission and version semantics are already accepted. The decisions below concern the more specific RA-04 criteria proposed here; no accepted upstream decision is reopened.

| Decision | Recommendation | Impact if revised | Status |
| --- | --- | --- | --- |
| OD-RA04-001 | Accept the evidence contract in Section 4.1: substantive object/objective/basis context, shared where unambiguous; labels and confidence alone are insufficient; no mandatory new field template. | Changes the boundary between supported and undetermined qualification; affects REQ-003/005/010 | OPEN |
| OD-RA04-002 | Accept all four Section 5.2 conditions for a review view inside a TC; otherwise retain the limitation and request human clarification or source revision. | Changes safe partial-review eligibility and reporting; affects REQ-007/012 | OPEN |
| OD-RA04-003 | Accept item inventory plus separately marked partial dimensions, with no qualification-to-coverage percentage or whole-package quality score. | Changes aggregation and the RA-05 handoff; affects REQ-008/013/015 | OPEN |

## 10. Author check, handoff, and exit

The following author checks are recorded separately from the formal static review. The same assistant prepared and checked the draft; this is not independent assurance.
...
| Normative status | 15 MUST / PROPOSED; no automatic acceptance |
...
| Static review with Project Owner disposition | PENDING |
...
RA-04 closes after disposition of the three recommendations and fifteen requirements, a focused static review, correction verification where needed, a verified baseline record, and an explicit Project Owner decision for RA-05. The next human walkthrough should start with Sections 3–5 and the examples in Section 7, then review the requirement and validation tables. R-08 remains active: future additions need a distinct decision, risk or validation purpose.
